...
const projects = [
  ...
  },
  {
  ...
  },
   {
    ...
    description: "Plataforma de nutrição personalizada, desenvolvida com Next.js e Tailwind CSS, que ajuda os usuários a alcançar seus objetivos de saúde e bem-estar através de um acompanhamento personalizado e orientações nutricionais.",
    image: "/assets/emconstrucao.png", 
    repoUrl: "https://github.com/pedroqueblas/RafaelCarvalhoPersonal",
    liveUrl: "https://rafael-carvalho-personal.vercel.app/",
  },
   {
    title: "Clara Santos",
    description: "Plataforma profissional com identidade visual moderna em tema azul tech, desenvolvida com Next.js e Tailwind CSS, focada em performance, experiência do usuário e posicionamento estratégico na área de backend Java.",
    image: "/assets/clarasantos.png", 
    repoUrl: "https://github.com/pedroqueblas/port-clarabsantos",
    liveUrl: "https://clarasantos.vercel.app/",
  },
  {
    title: "Tamo Junto",
